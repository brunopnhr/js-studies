...
var sudeste = ['Espirito Santo', 'Sao Paulo', 'Rio de Janeiro', 'Minas Gerais'];
...
*/
var nordeste = ['Maranhao', 'Piaui', 'Ceara', 'Rio Grande do Norte', 'Paraiba', 'Pernambuco', 'Alagoas', 'Sergipe', 'Bahia'];
...
var tem7 = brasil.every(function(item){
		return item.length > 7;
});

console.log( tem7 ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras');
