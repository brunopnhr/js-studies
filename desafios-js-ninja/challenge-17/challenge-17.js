...
*/
    ...
    console.log(texto.replace(/Manuel Marques de Sousa/g, 'Bruno Silva Pinheiro'));
...
*/
    ...
    console.log(texto.replace(/brasileiro/g,"cearense"));
...
console.log(texto.replace(/O Centauro de Luvas/g, (frase) => {
